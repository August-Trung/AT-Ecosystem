			...
			<div className="max-w-6xl mx-auto px-4 h-full flex items-center justify-between">
				<div
					...
					<span className="text-base font-black tracking-tighter text-white">
						TokDown<span className="text-pink-500">PRO</span>
					</span>
				</div>
				...
				<div className="flex items-center gap-4">
					...
					<button
						...
						className="hidden sm:block text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-pink-500 transition-colors">
						{t.navDonate}
					</button>
				</div>
			</div>
