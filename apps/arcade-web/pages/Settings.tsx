...
const Settings: React.FC = () => {
  ...
  return (
    <div className="min-h-screen pb-32 p-6 md:p-10 max-w-4xl mx-auto animate-fade-in-up relative">
      ...
      <button className="w-full mt-10 p-4 rounded-2xl border border-red-500/20 text-red-500 hover:bg-red-500/10 hover:border-red-500/30 transition-all flex items-center justify-center gap-2 font-bold">
        <LogOut size={20} />
        Reset All Settings
      </button>
